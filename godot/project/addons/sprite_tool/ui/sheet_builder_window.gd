...
@onready var _cell_w: SpinBox = get_node("Scroll/VBox/Split/RightPanel/ParamCard/ParamVBox/CellRow/CellW")
@onready var _cell_h: SpinBox = get_node("Scroll/VBox/Split/RightPanel/ParamCard/ParamVBox/CellRow/CellH")
